...
@interface ContactsViewController () <UserGroupDelegate>{
...
#pragma mark 初始化界面
//TODO: 此方法在iOS8之前调用 init方法的时候会被调用，在iOS9之后调用init方法不会被调用了
...
- (void)viewDidLoad {
    ...
    [self fetchContactsAction];//改变登录账号后需要重新刷新展示好友数据
