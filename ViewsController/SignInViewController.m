...
- (IBAction)SignUpView:(id)sender
{
    ...
    self.isSignIn = YES;
    [[NSUserDefaults standardUserDefaults] setObject:@"13612345678" forKey:XMPP_USER_ID];
    [[NSUserDefaults standardUserDefaults] setObject:@"13612345678" forKey:XMPP_PASSWORD];
    [[XMPPManager sharedManager] connectThenSignIn];
...
-(IBAction)forgetPW:(id)sender
{
    ...
    self.isSignIn = YES;
    [[NSUserDefaults standardUserDefaults] setObject:@"17875649879" forKey:XMPP_USER_ID];
    [[NSUserDefaults standardUserDefaults] setObject:@"17875649879" forKey:XMPP_PASSWORD];
    [[XMPPManager sharedManager] connectThenSignIn];
