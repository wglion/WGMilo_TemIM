...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(createTip) name:@"CREATE_ROOM_SUCCESS" object:nil];
...
#pragma mark - Notification 创建房间成功
- (void)createTip
{
    NSLog(@"CreateRoomViewController xmppRoom聊天室已创建...");
